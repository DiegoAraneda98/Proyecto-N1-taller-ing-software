...
if ($navbarType === 'type1') {
  ...
  if ($_SESSION['tipo_usuario'] !== 'admin') {
    echo '<li class="nav-item"> 
              <a class="nav-link ' . ($page === 'vehiculos/mis_vehiculos' ? 'active' : '') . '" href="index.php?p=vehiculos/mis_vehiculos">Mis vehiculos</a> 
            </li> 
            <li class="nav-item"> 
    ...
    echo '<li class="nav-item"> 
  <a class="nav-link ' . ($page === 'admin/admin_vehiculos' ? 'active' : '') . '" href="index.php?p=admin/admin_vehiculos">Vehiculos</a> 
</li> 
<li class="nav-item"> 
<a class="nav-link ' . ($page === 'admin/admin' ? 'active' : '') . '" href="index.php?p=admin/admin">Usuarios</a> 
          ...
          <nav class="navbar navbar-expand-lg bg-body-tertiary">
              <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
                      <ul class="navbar-nav nav-underline ms-auto mb-2 mb-lg-0">
                      <li class="nav-item"> 
                      <a class="nav-link hidden ' . ($page === 'inicio' ? 'active' : '') . '" href="index.php?p=inicio">¿Quienes somos?</a> 
                    </li> 
                    <li class="nav-item"> 
                      <a class="nav-link ' . ($page === 'vehiculos/mis_vehiculos' ? 'active' : '') . '" href="index.php?p=vehiculos/mis_vehiculos">Mis vehiculos</a> 
                    </li> 
  ...
  /* } elseif ($navbarType === 'type4') {
    echo ' <div class="container-fluid fondo-perfil"> <!-- nav bar extenso, con foto-->
    <div class="row bg-light">
        <div class="col-12">
            <nav class="navbar navbar-expand-lg bg-body-tertiary">
                <div class="container-fluid">
