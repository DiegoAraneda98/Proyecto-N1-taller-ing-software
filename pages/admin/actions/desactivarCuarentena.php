...
try {
    ...
    $updateQuery = "UPDATE usuarios SET cuarentena = 0";
    ...
    foreach ($correos as $correo) {
        ...
        $subject = "Desactivación de la cuarentena";
        $subject = utf8_decode($subject);

        //Content
        $mail->isHTML(true);
        $mail->Subject = $subject;
        $mail->Body =   'El ministerio de Salud de Chile ha determinado que este establecimiento está actualmente fuera de cuarentena. Ahora el establecimiento funcionará de forma regular. Se les informará ante algún cambio. Desde ya, muchas gracias por su comprensión.';
