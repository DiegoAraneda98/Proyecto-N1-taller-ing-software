                    ...
                    <div class="card text-center rounded-0 bg-body-secondary" style="width: 20rem;  height: 20rem;">
                        ...
                        <div class="d-flex justify-content-center mt-5 flex-wrap">
                            ...
                            <div class="card-body d-flex align-items-end justify-content-center">
                                <button type="button" class="btn btn-outline-danger text-white rojo w-100 p-3 ">SUBIR
                                    IMAGEN <i class="bi bi-upload text-end"></i></button>
                            </div>
                        </div>
                    </div>
                            ...
                            <form action="#" method="POST" id="<?php echo $id ?>">
                                ...
                                <div class="p-mt-2">Apellido:
                                    <div class="input-group mb-5 mt-2">
                                        <input data-target="apellido" type="text" class="form-control rounded-0"
                                            aria-label="Username" aria-describedby="basic-addon1"
                                ...
                                <div class="p-mt-2">E-Mail:
                                    <div class="input-group mb-4 mt-2">
                                        <input data-target="correo" type="text" class="form-control rounded-0"
                                            aria-label="Username" aria-describedby="basic-addon1"
                                ...
                                <div class="p-mt-2">Teléfono:
                                    <div class="input-group mb-4 mt-2">
                                        <input data-target="telefono" type="text" class="form-control rounded-0"
                                            aria-label="Username" aria-describedby="basic-addon1"
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-center mt-5">
                                    <a href="#"
                                        ...
                                        data-bs-toggle="modal" data-role="update-datos"
                                        data-id="<?php echo $id ?>">EDITAR
                                        DATOS</a>
                        ...
                        <div class="card-body">
                            <form action="#" method="POST" id="<?php echo $id ?>">
                                ...
                                <div class="d-flex justify-content-center mt-5">
                                    <a href="#"
                                        class="btn btn-danger text-white d-flex justify-content-center rojo w-50"
                                        data-bs-toggle="modal" data-role="update-password"
                                        data-id="<?php echo $id ?>">EDITAR CONTRASEÑA</a>
                                </div>
                            </form>
                        </div>
                    </div>
